...
import { CalendarDays, ChevronFirst, ChevronLast, ChevronLeft, ChevronRight } from "lucide-react";
...
export default async function EventsPage({
  ...
  const events = sortedEvents.slice((currentPage - 1) * eventsPerPage, currentPage * eventsPerPage);
        ...
        <div className="max-w-3xl mb-16">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-secondary-50 flex items-center justify-center">
              <CalendarDays size={20} className="text-secondary-600" />
            </div>
